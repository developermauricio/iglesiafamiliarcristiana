...
(function($) {
  ...
  function WPGPAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WPGPAjaxChosen.prototype.init = function() {
  ...
  WPGPAjaxChosen.prototype.events = function() {
  ...
  WPGPAjaxChosen.prototype.search_field_focused = function() {
  ...
  WPGPAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WPGPAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wpgp-chosen', _this.options.data).done( function( response ) {
  ...
  WPGPAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wpgp-hidden-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WPGPChosenOrder($hidden_value, true);
  ...
  $.fn.WPGPAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WPGPAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WPGPAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WPGPAbstractChosenOrder = (function() {

    function WPGPAbstractChosenOrder() {}

    WPGPAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WPGPAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WPGPAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WPGPAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WPGPAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WPGPAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WPGPAbstractChosenOrder.WPGPChosenOrder = function(select, order, force) {
    ...
    return WPGPAbstractChosenOrder;
  ...
  $.fn.extend({
    WPGPChosenOrder: function(order, force) {
      return _WPGPChosenOrder.WPGPChosenOrder(this, order, force);
    }
  });

  this._WPGPChosenOrder = (function(_super) {
    __extends(_WPGPChosenOrder, _super);

    function _WPGPChosenOrder() {
      _ref = _WPGPChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WPGPChosenOrder.relAttributeName = 'data-option-array-index';

    _WPGPChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WPGPChosenOrder.getDOMElement = function(element) {
    ...
    _WPGPChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WPGPChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WPGPChosenOrder;

  })(WPGPAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWPGP = FormSerializer.serializeObject;
    $.fn.serializeJSONWPGP   = FormSerializer.serializeJSON;
  }
