...
var benefits_Benefits = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Benefits, [{
    ...
    value: function render() {
      ...
      }, Object(external_this_wp_i18n_["__"])('No thanks', 'woocommerce')), !isJetpackConnected && !isRequesting && !pluginsRemaining.length && Object(external_this_wp_element_["createElement"])(connect["a" /* default */], {
        autoConnect: true,
...
/* harmony default export */ var benefits = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
...
function business_details_createSuper(Derived) { var hasNativeReflectConstruct = business_details_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
    ...
    value: function render() {
      ...
      return Object(external_this_wp_element_["createElement"])(external_this_wc_components_["Form"], {
        ...
        return Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])(external_this_wc_components_["H"], {
          ...
          required: true
        }, getInputProps('other_platform_name'))))), showExtensions && _this5.renderBusinessExtensions(values, getInputProps), Object(external_this_wp_element_["createElement"])("div", {
          className: "woocommerce-profile-wizard__card-actions"
        }, Object(external_this_wp_element_["createElement"])(build_module_button["a" /* default */], {
          isPrimary: true,
        ...
        }, !hasInstallActivateError ? Object(external_this_wp_i18n_["__"])('Continue', 'woocommerce') : Object(external_this_wp_i18n_["__"])('Retry', 'woocommerce')), hasInstallActivateError && Object(external_this_wp_element_["createElement"])(build_module_button["a" /* default */], {
          onClick: function onClick() {
            return goToNextStep();
          }
        }, Object(external_this_wp_i18n_["__"])('Continue without installing', 'woocommerce'))))), showExtensions && _this5.renderBusinessExtensionHelpText(values));
      });
    }
  }]);
...
/* harmony default export */ var business_details = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
...
/* harmony default export */ var product_types = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
  var _select = select(external_this_wc_data_["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select.getProfileItems,
      getOnboardingError = _select.getOnboardingError;
...
function usage_modal_createSuper(Derived) { var hasNativeReflectConstruct = usage_modal_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
...
/* harmony default export */ var usage_modal = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
...
/* harmony default export */ var store_details = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
  var _select = select(external_this_wc_data_["SETTINGS_STORE_NAME"]),
      getSettings = _select.getSettings,
      getSettingsError = _select.getSettingsError,
      isGetSettingsRequesting = _select.isGetSettingsRequesting;
...
var style = __webpack_require__(901);
...
var provider = __webpack_require__(902);

// EXTERNAL MODULE: ./node_modules/@wordpress/components/build-module/form-file-upload/index.js
var form_file_upload = __webpack_require__(926);

// EXTERNAL MODULE: ./node_modules/@wordpress/components/build-module/drop-zone/index.js
var drop_zone = __webpack_require__(927);
...
var uploader_ThemeUploader = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(ThemeUploader, [{
    ...
    value: function render() {
      ...
      return Object(external_this_wp_element_["createElement"])(external_this_wc_components_["Card"], {
        className: classes
      }, Object(external_this_wp_element_["createElement"])(provider["c" /* default */], null, !isUploading ? Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])(form_file_upload["a" /* default */], {
        accept: ".zip",
      ...
      }, Object(external_this_wp_i18n_["__"])('Upload a theme', 'woocommerce')), Object(external_this_wp_element_["createElement"])("p", null, Object(external_this_wp_i18n_["__"])('Drop a theme zip file here to upload', 'woocommerce'))), Object(external_this_wp_element_["createElement"])(drop_zone["a" /* default */], {
...
var profile_wizard_style = __webpack_require__(903);
