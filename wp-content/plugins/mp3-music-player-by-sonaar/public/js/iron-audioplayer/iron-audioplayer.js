IRON.audioPlayer = function($){
	...
	var createFakeWave = function( audioPlayer ){
		...
		var biggestWave = 0;
		$(audioPlayer).find('.sonaar_fake_wave').each(function(){
			if ( this.offsetWidth > biggestWave){
				biggestWave = this.offsetWidth;
			} 
		})
		
		var linesnbr = biggestWave / 2; // 2px is the width area for each rect
